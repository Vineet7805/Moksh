...
public class JSchemaGeneratorGUI extends Composite {
	...
	public JSchemaGeneratorGUI(Composite parent, int style) {
		...
		btnGenerateDatarest.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					fos.flush();
					fos.close();
					String val=CG.generateClasses(basePackage.getText().toString(),folderLoc,startPage.getText(), htmlText.getText(), javaScriptText.getText(), cssText.getText());
					if(val!=null)
		...
		startPage = new Text(composite_3, SWT.BORDER | SWT.MULTI);
		startPage.setText("<style>\r\n.center {\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  height: 80px;\r\n  border: 2px solid grey; \r\n}\r\n\r\n.button {\r\n  border: none;\r\n  color: white;\r\n  padding: 12px 24px;\r\n  text-align: center;\r\n  text-decoration: none;\r\n  display: inline-block;\r\n  font-size: 16px;\r\n  margin: 4px 2px;\r\n  transition-duration: 0.4s;\r\n  cursor: pointer;\r\n  background-color: white; \r\n  color: black; \r\n  border: 2px solid #008CBA;\r\n}\r\n\r\n.button:hover {\r\n  background-color: #008CBA;\r\n  color: white;\r\n}\r\n\r\n.center button{\r\n  margin:10px;\r\n}\r\n</style>\r\n\r\n<div class=\"center\">\r\n  %navigation%\r\n</div>");
